...
def load_data():
    ...
    colll = listings[0]['keysArr']
    for i in listings[1:]:
        
        coins[str(i[colll.index('id')])] = i[colll.index('slug')]
    ...
    for i in listings[1:]:
      coin_name.append(i[colll.index('slug')])
      coin_symbol.append(i[colll.index('symbol')])
      price.append(i[colll.index('quote.'+currency_price_unit+'.price')])
      percent_change_1h.append(i[colll.index('quote.'+currency_price_unit+'.percentChange1h')]) # percent_change_1h
      percent_change_24h.append(i[colll.index('quote.'+currency_price_unit+'.percentChange24h')]) #percent_change_24h
      percent_change_7d.append(i[colll.index('quote.'+currency_price_unit+'.percentChange7d')]) # percent_change_7d
      market_cap.append(i[colll.index('quote.'+currency_price_unit+'.marketCap')]) # market_cap
      volume_24h.append(i[colll.index('quote.'+currency_price_unit+'.volume24h')]) # volume_24h
